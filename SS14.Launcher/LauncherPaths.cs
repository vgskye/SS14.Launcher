...
public static class LauncherPaths
{
    ...
    public static readonly string PathContentMetaDb = Path.Combine(DirLocalData, "content.db");
    public static readonly string PathContentDataDb = Path.Combine(DirLocalData, "content");
